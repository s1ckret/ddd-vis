    ...
    def paintEvent(self, event):
        ...
        if self.num_channels == 0:
            ...
            painter.drawText(
                ...
                "Audio stream inactive. Connect input or load a WAV file, then press 'Play' to visualize."
            )
            return
...
class BodyWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.group_box = QGroupBox("Audio Level Oscilloscope")
        group_layout = QVBoxLayout(self.group_box)
        group_layout.setContentsMargins(10, 15, 10, 10)
        
        self.chart = MultiChannelChart()
        group_layout.addWidget(self.chart)
        
        layout.addWidget(self.group_box)

    def update_levels(self, levels):
        """Pass new levels data to the nested chart widget."""
        self.chart.update_levels(levels)

    def reset_chart(self):
        """Reset internal chart drawing buffers."""
